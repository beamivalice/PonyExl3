...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="text corpus for BF16 calibration capture; defaults to a bundled "
        "WikiText-2 excerpt so a basic conversion needs only --in-dir / --out-dir / --bits",
    )
    ...
    if args.calibration_text is None:
        args.calibration_text = default_calibration_text()
