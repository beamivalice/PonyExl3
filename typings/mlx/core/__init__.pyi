...
def softmax(a: array, /, axis: Union[None, int, Sequence[int]] = None, *, precise: bool = False, stream: Union[None, Stream, Device] = None) -> array:
    """
...
def gather_mm(a: array, b: array, /, lhs_indices: array | None = None, rhs_indices: array | None = None, *, sorted_indices: bool = False, stream: Union[None, Stream, Device] = None) -> array:
    """
...
def eval(*args: array | dict[str, array] | Any, **kwargs: Any) -> None:
    """
...
def async_eval(*args: array) -> None:
    """
