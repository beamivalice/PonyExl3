...
**249 tests** run without any checkpoint on disk (synthetic layers + CPU/MLX
parity + converter gates). Fifteen integration tests are skipped unless you set model env vars — see README
